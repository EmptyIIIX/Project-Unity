...
//    [SerializeField] private float timeClingLimit = 3f;
//    [SerializeField] private float durationCling;
...
//    {
//        //check to assign physicMaterial2D with friction = 0
...
//        // start clinging to walljump
//        if (Input.GetButtonDown("Jump") && GroundCheck.IsClingable)
//        {
//            Cling();
//        }
...
//    private void Cling()
//    {
//        if(durationCling <= 0 || GroundCheck.IsGrounded == false)
//        {
...
//        //duration of cling time
//        if (GroundCheck.IsClingable && GroundCheck.IsGrounded == false)
//        {
